...
const technologies: Technology[] = [
  ...
  },
  {
    ...
    icon: 'Square',
    shortDesc: 'Обработка толстого акрила высшего качества',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Мы — производственная компания полного цикла, специализирующаяся на создании наград и корпоративных подарков. Используем передовые технологии и традиционные ремесленные методы.
            </p>
          </div>
