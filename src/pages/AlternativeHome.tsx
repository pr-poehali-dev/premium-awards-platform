    ...
    <>
      ...
      <div className="relative w-full h-screen overflow-hidden bg-black">
        ...
        <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div className="max-w-xl">
                <div className="overflow-hidden mb-6">
                  <div
                    ...
                    className="inline-flex items-center gap-2 bg-primary/20 backdrop-blur-md border border-primary/30 rounded-full px-4 py-2 animate-in slide-in-from-left duration-700"
                  >
                ...
                <div className="overflow-hidden mb-8">
                  <div
                    ...
                    className="flex items-start gap-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-5 max-w-md animate-in slide-in-from-left duration-700 delay-400"
                  >
          ...
          <div className="hidden lg:block absolute right-8 xl:right-16 bottom-32">
                ...
                {visibleCards.map((dest, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`
                        relative rounded-xl overflow-hidden cursor-pointer transition-all duration-700 ease-out
                        ${isActive ? 'w-56 h-72 shadow-2xl scale-105' : 'w-48 h-64 opacity-80 hover:opacity-100 hover:scale-105'}
                      `}
                      style={{
