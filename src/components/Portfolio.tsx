...
const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: 'Подарки',
    year: 2023,
    description: 'Эксклюзивные подарочные наборы для руководителей высшего звена. Включали премиальные аксессуары из кожи, швейцарские часы и персонализированную упаковку.',
